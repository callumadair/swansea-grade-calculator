...
fn weight_and_average_4yr(grade_array_tuple: &mut ([u8; 8], [u8; 8], [u8; 8])) -> f32 {
    let mut sum: f32 = 0.0;
...
fn weight_and_average_3yr(grade_array_tuple: &mut ([u8; 8], [u8; 8])) -> f32 {
    let mut sum: f32 = 0.0;
